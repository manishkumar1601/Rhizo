...
if (!opts['test']) setInterval(() => {
  conn.logger.info('Note : Dont Turn Off Your Internet connection')
  if (JSON.stringify(global.DATABASE.data) == lastJSON) conn.logger.info('Rhizo -- Made By TOXIC-DEVIL')
  else {
    global.DATABASE.save()
    conn.logger.info('https://github.com/TOXIC-DEVIL')
...
global.reloadHandler = function () {
  ...
  conn.welcome = 'ᴏɪɪ, @user! 👋\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ *@subject* 💫\nꜱᴛᴀʏ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ʀᴇꜱᴘᴇᴄᴛ ᴀᴅᴍɪɴꜱ 😜💖'
  conn.bye = 'ᴏɪɪ, @user! 👋\nɢᴏᴏᴅʙʏᴇ ꜰʀᴏᴍ *@subject*\nʜᴏᴘᴇꜰᴜʟʟʏ Qᴜɪᴇᴛ ʀɪᴘ! 🌹'
  conn.spromote = '『 ᴘʀᴏᴍᴏᴛᴇ ᴅᴇᴛᴇᴄᴛᴇᴅ 』\nᴏɪɪ, @user! ʏᴏᴜ ᴀʀᴇ ɴᴏᴡ ᴀɴ ᴀᴅᴍɪɴ! 😘💖'
  conn.sdemote = '『 ᴅᴇᴍᴏᴛᴇ ᴅᴇᴛᴇᴄᴛᴇᴅ 』\nᴏɪɪ, @user! ʏᴏᴜ ᴀʀᴇ ɴᴏ ʟᴏɴɢᴇʀ ᴀɴ ᴀᴅᴍɪɴ! 😖💔'
