    ...
    try {
      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          if (plugin.menu && !isMenu) { // Menu Message
            fail('menu', m, this)
            continue
          }
...
⭕️ ᴅᴇᴛᴇᴄᴛᴇᴅ @${m.participant.split`@`[0]} ᴅᴇʟᴇᴛᴇᴅ ᴍᴇꜱꜱᴀɢᴇ ⭕️

💬 ᴛᴏ ᴛᴜʀɴ ᴏꜰꜰ ᴛʜɪꜱ ꜰᴇᴀᴛᴜʀᴇ, ᴛʏᴘᴇ
*.ᴇɴᴀʙʟᴇ ᴅᴇʟᴇᴛᴇ*
`.trim(), m.message, {
      contextInfo: {
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: '【﻿❗️】ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜꜱᴇᴅ ʙʏ ᴛʜᴇ *ᴏᴡɴᴇʀ!*',
    owner: '【﻿❗️】ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜꜱᴇᴅ ʙʏ ᴛʜᴇ *ᴏᴡɴᴇʀ!*',
    menu: '【﻿❗️】ʜᴇʏ ᴜꜱᴇʀ, ᴛʀʏ ᴛʏᴘɪɴɢ *!list*',
    mods: '【﻿❗️】ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜꜱᴇᴅ ʙʏ ᴛʜᴇ *ᴍᴏᴅᴇʀᴀᴛᴏʀꜱ!*',
    premium: '【﻿❗️】ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜꜱᴇᴅ ʙʏ ᴛʜᴇ *ᴘʀᴇᴍɪᴜᴍ!*',
    group: '【﻿❗️】ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜꜱᴇᴅ ɪɴ *ɢʀᴏᴜᴘꜱ!*',
    private: '【﻿❗️】ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜꜱᴇᴅ ɪɴ *ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛꜱ!*',
    admin: '【﻿❗️】ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜꜱᴇᴅ ʙʏ ᴛʜᴇ *ɢʀᴏᴜᴘ ᴀᴅᴍɪɴꜱ!*',
    botAdmin: '【﻿❗️】ᴍᴀᴋᴇ ꜱᴜʀᴇ ᴛʜᴀᴛ ᴛʜᴇ ʙᴏᴛ ɪꜱ ᴀɴ *ᴀᴅᴍɪɴ* ɪɴ ᴛʜɪꜱ *ɢʀᴏᴜᴘ*!',
    unreg: '【﻿❗️】ᴏɪɪ, ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ʀᴇɢɪꜱᴛᴇʀᴇᴅ\nᴘʟᴇᴀꜱᴇ ʀᴇɢɪꜱᴛᴇʀ ᴛᴏ ᴜꜱᴇ\nᴛᴏ ʀᴇɢɪꜱᴛᴇʀ, ᴛʏᴘᴇ *!ʀᴇɢ ɴᴀᴍᴇ/ᴀɢᴇ*\nᴇxᴀᴍᴘʟᴇ :\n!ʀᴇɢ ᴀʙʜɪɴᴀᴠ/22'
  }[type]
